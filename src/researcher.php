       ...
       if (loadvar('updatesessionpage') != 2) {
        ...
        if (isset($_SESSION['LASTPAGE'])) {
            switch ($_SESSION['LASTPAGE']) {
                 ...
                 case 'researcher.data.rawdata': return $this->ShowRawData(); break;
                 case 'researcher.data.timings': return $this->ShowTimingsData(); break;
                 case 'researcher.data.timingsres': return $this->showTimingsDataRes(); break;
                 case 'researcher.data.paradata': return $this->ShowParaData(); break;
                 case 'researcher.data.paradatares': return $this->showParaDataRes(); break;
                 case 'researcher.data.auxiliarydata': return $this->ShowAuxData(); break;
                 case 'researcher.data.auxiliarydatares': return $this->ShowAuxDataRes(); break;
                 case 'researcher.datasingle': return $this->showDataSingle(); break;
                 case 'researcher.datasingleres': return $this->showDataSingleRes(); break;
                 ...
                 case "researcher.reports.timings.perscreen": return $this->showReportsTimingsPerScreen(); break;
                 case "researcher.reports.timings.perscreen.res": return $this->showReportsTimingsPerScreenRes(); break;
                 case "researcher.reports.platform": return $this->showReportsPlatform(); break;
