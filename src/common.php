...
class Common {    
    ...
    static function surveyInputMasks() {
        return array(INPUTMASK_INTEGER => "Integer", INPUTMASK_DOUBLE => "Real", INPUTMASK_USPHONE => "US Phone", INPUTMASK_USCURRENCY => "US currency", INPUTMASK_EUROCURRENCY => "Euro currency", INPUTMASK_EMAILSHORT => "Email", INPUTMASK_CUSTOM => "Custom");
    }
