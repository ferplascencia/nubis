...
class BasicEngine extends Object {
    ...
    function isFirstState() {
        ...
        //echo 'select count(*) as cnt from ' . Config::dbSurveyData() . '_states where suid=' . prepareDatabaseString($this->getSuid()) . ' and primkey = "' . prepareDatabaseString($this->primkey) . '" and mainseid=' . prepareDatabaseString($this->getMainSeid()) . ' and displayed != "" group by primkey';
